...
Nombre del alumno: Vanessa Suarez
Número de control: 23212236
Correo institucional: L23212236@tectijuana.edu.mx
...
print(f"El valor de la resistencia es de {Re} Ohms.\n")
print(f"El valor de la resistencia es de {Rr} Ohms.\n")
